# ── SNIPPET: scheduler_query_slurm_squeue_job_present/poll_until_jobids_absent_barrier ─
# Scheduler:   slurm
# Tool:        any
# Tested:      MD/util/monitor_jobs.py
# Notes: This is a blocking barrier; it does not resubmit or heal failures.
# ────────────────────────────────────────────────────────────
